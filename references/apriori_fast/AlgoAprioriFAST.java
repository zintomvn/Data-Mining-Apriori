...
/**
 * This is an efficient implementation of the Apriori algorithm with multiple
 * optimizations. Besides using a hash-tree for support counting (as in AlgoAprioriHT)
...
public class AlgoAprioriFAST {
	 ...
	 *                               hash tree
	 * @return the frequent itemsets found (Itemsets object), or null if saving to file
	...
	public Itemsets runAlgorithm(double minsup, String input, String output, int hash_tree_branch_count)
		...
		// Save frequent items of size 1 to output (using original names)
		for (Map.Entry<Integer, Integer> entry : frequentItemsList) {
	...
	public void printStats() {
		System.out.println("============= APRIORI-FAST 2.65 - STATS =============");
